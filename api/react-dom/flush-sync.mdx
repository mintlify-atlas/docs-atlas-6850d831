...
- [useLayoutEffect](/api/react/use-layout-effect) - Run effects synchronously after DOM updates
- [useEffect](/api/react/use-effect) - Run effects asynchronously
- [startTransition](/api/react/start-transition) - Mark updates as non-urgent (opposite of flushSync)
