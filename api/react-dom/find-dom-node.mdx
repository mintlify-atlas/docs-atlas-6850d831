...
- [useRef](/api/hooks/use-ref) - Create refs in function components
- [forwardRef](/api/react-api) - Forward refs through components
- [useImperativeHandle](/api/hooks/use-imperative-handle) - Customize ref values
- [createRef](/api/react-api) - Create refs in class components
